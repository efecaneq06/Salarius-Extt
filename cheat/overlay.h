...
void overlay::SetupWindow()
{
    ...
    SetWindowLong(overlay::Window, GWL_EXSTYLE, WS_EX_LAYERED | WS_EX_TRANSPARENT | WS_EX_TOOLWINDOW | WS_EX_TOPMOST);
...
VOID overlay::EndRender()
{
    ...
    g_pSwapChain->Present(0, 0); // vsync kapali: ESP max FPS'de cizilir (once 1,0 = 60Hz kilitliydi)
}
